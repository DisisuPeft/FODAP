...
class EstadisticasController extends Controller
{
    ...
    public static function docente_carrera()
    {
        ...
        $total_mecanica = 0;
        $total_m_mecanica = 0;
        $total_f_mecanica = $mecanica[0]->docente_inscrito->where(function ($query) {
            $query->where('sexo', 2)
                ->where('carrera_id', 1);
        })->count();
        ...
        for ($i = 0; $i < count($sistemas) - 1; $i++) {
            ...
            $total_f_sistemas = $sistemas[$i]->docente_inscrito->where('sexo', 2)->count() + $sistemas[$i + 1]->docente_inscrito->where('sexo', 1)->count();
        }
        $total_industrial = 0;
        ...
        for ($i = 0; $i < count($industrial) - 1; $i++) {
            ...
            $total_f_industrial = $industrial[$i]->docente_inscrito->where('sexo', 2)->count() + $industrial[$i + 1]->docente_inscrito->where('sexo', 1)->count();
        }
        //        $total_electronica = 0;
