...
<template>
    <v-dialog width="auto" v-model="props.modelValue">
        <v-card width="auto" height="700">
            <v-card-title class="text-h6 bg-blue-darken-4">{{
                curso.nombreCurso
            }}</v-card-title>
            <v-card-text>
                ...
                <div class="flow-root ... pt-3">
                    <strong
                        >Asignaturas en la que se requiere formación o
                        actualización:
                    </strong>
                    <v-divider></v-divider>
                ...
                <div class="flow-root ... pt-7">
                    <strong
                        >Contenidos temáticos en que se requiere la formación o
                        actualización:
                    </strong>
                    <v-divider></v-divider>
                ...
                <div class="flow-root ... pt-5">
                    <strong
                        >Periodo en el que se requiere la formación o
                        actualización (enero-junio o agosto diciembre):
                    </strong>
                ...
                <div class="flow-root ... pt-5">
                    ...
                    <!-- <template v-if="curso.periodo === 1"> -->
                    <span class="text-sm">{{
                        curso.departamento?.nameDepartamento
                    }}</span>
                    <!-- </template> -->
                </div>
                <div class="flow-root ... pt-5">
                ...
                <div class="flow-root ... pt-5">
                    ...
                    <span class="text-sm"
                        >{{ curso.hora_I }} a {{ curso.hora_F }}</span
                    >
                </div>
                <div class="flow-root ... pt-5">
                    <strong>Lugar: </strong>
                    <span class="text-sm">{{ curso.lugar?.nombreAula }}</span>
                    <!-- <span v-if="curso.aula" class="text-sm">{{
                        curso.aula
                    }}</span> -->
                </div>
                <div class="flow-root ... pt-5">
