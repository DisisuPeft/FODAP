            ...
            <v-container class="mt-5">
                                ...
                                <v-col align="end" cols="7" class="mb-0 pa-0">
                                    <div class="d-flex justify-start mb-5">
                                        <v-tooltip location="right">
                                            ...
                                            <span
                                                >Anotar la dimensión, resultado
                                                de la evaluación docente, en la
                                                que se requiere formación
                                                docente.</span
                                            >
                                        </v-tooltip>
                                    </div>
                                ...
                                <v-col align="start" cols="7" class="mb-0 pa-0">
                                    <div class="d-flex justify-start mb-5">
                                        <v-tooltip location="right">
                                            ...
                                            <span
                                                >Anotar las competencias en que
                                ...
                                <v-col align="start" cols="2" class="mb-0 pa-0">
                                    <div class="d-flex justify-start mb-5">
                                        <v-tooltip location="right">
                                            ...
                                            <span
                                                >Anotar los contenidos temáticos
                                                de la asignatura que requiere la
                ...
                <v-row justify="center">
                            ...
                            <v-col align="start" cols="2" class="mb-0 pa-0">
                                <div class="d-flex justify-start mb-5">
                                    <v-tooltip location="right">
                                        ...
                                        <span
                                            >Indicar el número de profesores(as)
                                            que requieren Formación Docente o
                                            Actualización Profesional.</span
                                        >
                                    </v-tooltip>
                                </div>
                            ...
                            <v-col align="start" cols="1" class="mb-0 pa-0">
                                <div class="d-flex justify-start mb-5">
                                    <v-tooltip location="left">
                                        ...
                                        <span
                                            >Indicar el periodo en el que se
                                            requiere la formación docente o
                                            actualización profesiona
                                            (enero-junio o
                                            agosto-diciembre)</span
                                        >
                                    </v-tooltip>
                                </div>
                            </v-col>
                            ...
                            <v-col align="start" cols="9" class="mb-0 pa-0">
                                <div class="d-flex justify-start mb-5">
                                    <v-tooltip location="right">
                                        ...
                                        <span
                                            >La modalidad en la que se realizara
                                            el curso.</span
                                        >
                                    </v-tooltip>
                                </div>
                    ...
                    <v-col cols="12">
                        <v-row justify="center">
                            <v-col align="start" cols="5">
                                <InputLabel
                                    for="carrera"
                                    value="PARA LOS(AS) PROFESORES(AS) DE LA ACADEMIA DE"
                                />
                            </v-col>
                            <v-col align="start" cols="7" class="mb-0 pa-0">
                                <div class="d-flex justify-start mb-5">
                            ...
                            <v-col align="start" cols="7" class="mb-0 pa-0">
                                <div class="d-flex justify-start mb-5">
                                    <v-tooltip location="right">
                                        ...
                                        <span
                                            >Anotar el nombre del facilitador
                                            (a) que impartirá el
                                            curso/taller.</span
                                        >
                                    </v-tooltip>
                    ...
                    <v-col align-self="center">
                            ...
                            <v-col align="start" cols="7" class="mb-0 pa-0">
                                <div class="d-flex justify-start mb-5">
                                    <v-tooltip location="top">
                                        ...
                                        <span
                                            >En caso de que el facilitador sea
                                            externo</span
                                        >
                                    </v-tooltip>
                                </div>
                        ...
                        <v-text-field
                            v-model="form.facilitador_externo"
                        ></v-text-field>
                    </v-col>
                    <v-col cols="12">
                        <v-row justify="center">
                                ...
                                <div class="d-flex justify-start mb-5">
                                    <template v-if="form.tipo === 1">
                                        <v-tooltip location="bottom">
                                            ...
                                            <span
                                                >Anotar el nombre del curso,
                                                taller, conferencias, etc., que
                                                se llevarán a cabo para la
                                                Formación Docente del (de la)
                                                profesor(a) en las dimensiones
                                                de la Evaluación Docente.</span
                                            >
                                        </v-tooltip>
                                    </template>
                                    <template v-else>
                    ...
                    <v-col cols="6">
                        <v-row justify="center">
                            <v-col align="start" cols="8">
                                <h4>
                                    Elegir las fechas en que se realizará la
                                    actividad o evento
                                </h4>
                            </v-col>
                            <v-col align="start" cols="4" class="mb-0 pa-0">
                                <div class="d-flex justify-start mb-5">
                                    <v-tooltip location="right">
                                        ...
                                        <span
                                            >Seleccionar la fecha en que se
                    ...
                    <v-col cols="6">
                        <v-row justify="center">
                            <v-col align="start" cols="5">
                                <h4>
                                    Elegir los horarios en que se realizará la
                                    actividad o evento
                                </h4>
                            </v-col>
                    ...
                    <v-col align-self="center" cols="12">
                        <v-row justify="center">
                            <v-col align="start" cols="5">
                                <InputLabel
                                    for="objetivo"
                                    value="Objetivo de la actividad o evento"
                                />
                            </v-col>
                            <v-col align="start" cols="7" class="mb-5 pa-0">
                                <div class="d-flex justify-end mb-0">
                                    <v-tooltip location="right">
                                        ...
                                        <span
                                            >Anotar el objetivo de la actividad
                                            o evento.
                                        </span>
                                    </v-tooltip>
                                </div>
