        ...
        if (res.isConfirmed) {
            ...
            form_carrera.post(route("store.carrera"), {
                onSuccess: () => {
                    ...
                    success_alert(
                        "Exito",
                        "El área académica fue creada con exito."
                    );
                    router.reload();
                },
                onError: () => {
        ...
        if (res.isConfirmed) {
            ...
            form.post(route("config.dates"), {
                onSuccess: () => {
                    ...
                    success_alert(
                        "Fechas actualizadas",
                        "Las fechas fueron establecidas con exito."
                    );
                    // router.reload()
                },
                onError: () => {
        ...
        if (res.isConfirmed) {
            ...
            form_file.post(route("subir.cvu"), {
                ...
                onSuccess: () => {
                    ...
                    success_alert(
                        "Exito",
                        "La hoja membretada se ha subido con exito"
                    );
                },
                onError: () => {
...
const show_visibilty = () => {
    passwordFielType.value =
        passwordFielType.value === "password" ? "text" : "password";
};
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6 mt-16 pt-16">
                ...
                <form @submit.prevent="submit">
                    <div class="grid grid-rows-2">
                        <div class="flex justify-center">
                            <div class="grid grid-cols-1 md:grid-cols-2">
                                <div class="flex justify-center m-2">
                                    ...
                                    <input
                                        class="mt-1 block w-[300px] px-3 py-2 bg-white border border-slate-300 rounded-md text-sm shadow-sm placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-1 focus:ring-sky-500"
                                        type="date"
                        ...
                        <div class="flex justify-end items-center mr-10">
                            <button
                                class="rounded-md bg-sky-500 hover:bg-sky-700 p-4 text-white"
                            >
                                Guardar
                            </button>
                        </div>
            ...
            <div class="p-4 mt-7 sm:p-8 bg-white shadow sm:rounded-lg">
                ...
                >
                    <button
                        class="rounded-md bg-sky-500 hover:bg-sky-700 p-4 text-white"
                        @click="create_carrera = true"
                    >
                        Crear aréa académica
                    </button>
                    <Modal :show="create_carrera" @close="close_modal">
                        ...
                        >
                            <div
                                class="p-4 mt-7 sm:p-8 bg-white shadow sm:rounded-lg"
                            >
                                <form
                                    class="mt-6 space-y-6"
                                    @submit.prevent="crear_carrera"
                                >
                                    <div class="container mx-auto px-4">
                                        <div class="grid grid-rows-1">
                                            <div class="grid grid-cols-1">
                                                ...
                                                >
                                                    <input
                                                        class="mt-1 block px-3 py-2 bg-white border border-slate-200 rounded-md text-sm shadow-2xl placeholder-slate-400 focus:outline-none focus:border-sky-950 focus:ring-1 focus:ring-sky-500 w-full"
                                                        v-model="
                                                            form_carrera.nombre_carrera
                                                        "
                                                    />
                                                </div>
                                            </div>
                                            <div class="grid grid-cols-1">
                                                ...
                                                >
                                                    <InputLabel
                                                        for="presidente_academia"
                                                        value="Presidente de la academia"
                                                    />
                                                </div>
                                                <div
                                                    class="flex justify-center"
                                                >
                                                    <v-autocomplete
                                                        v-model="
                                                            form_carrera.presidente_academia
                                                        "
                                                        :items="props.docente"
                                            ...
                                            <div class="grid grid-cols-1">
                                                ...
                                                >
                                                    <InputLabel
                                                        for="presidente_academia"
                                                        value="Departamento al que la carrera pertenece"
                                                    />
                                                </div>
                                                <div
                                                    class="flex justify-center"
                                    ...
                                    <div class="flex justify-end">
                                        <div class="grid grid-rows-1">
                                            <div class="grid grid-cols-2">
                                                ...
                                                <div class="flex justify-end">
                                                    <button
                                                        class="rounded-md bg-red-500 hover:bg-red-700 p-4 text-white"
                                                        @click="close_modal"
                                                    >
                                                        Cancelar
                                                    </button>
                                                ...
                                                >
                                                    ...
                                                    >
                                                        <p
                                                            v-if="
                                                                form_carrera.recentlySuccessful
                                                            "
                ...
                <div class="grid grid-rows-1 p-4">
                    <div class="flex justify-end">
                        <div class="grid grid-cols-1">
                            <button
                                class="rounded-md bg-sky-500 hover:bg-sky-700 p-4 text-white"
                                @click="open_modal_cuenta"
                            >
                                Crear correo de jefe académico
                            </button>
                            <Modal
                                :show="create_cuenta"
                                @close="close_modal_cuenta"
                            >
                                <div class="grid grid-rows-1">
                                    <div class="flex justify-end">
                                        <v-btn
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            ...
                                                            <div>
                                                                <InputLabel
                                                                    for="docente"
                                                                    value="Docente o administrativo asociado a este perfil"
                                                                />
                                                            ...
                                                            >
                                                                ...
                                                                >
                                                                    <p
                                                                        v-if="
                                                                            form_cuenta.recentlySuccessful
                                                                        "
                                                                        class="text-sm text-gray-600"
                                                                    >
                                                                        Guardado.
            ...
            <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                ...
                <div>
                    ...
                    <div class="flex justify-start">
                        <button
                            class="rounded-xl bg-sky-500 p-3 hover:bg-sky-700 ml-4"
                            @click="modal_documentos = true"
                        >
                    ...
                    <Modal :show="modal_documentos">
                        ...
                        <div class="grid grid-rows-1 p-5">
                            ...
                            <div class="flex justify-end p-5">
                                <button
                                    class="rounded-xl bg-sky-500 p-3 hover:bg-sky-700"
                                    @click="submit_documentos"
                                >
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2">
                            ...
                            <div class="flex justify-start ml-10 mb-2">
                                <v-tooltip location="bottom">
                                    ...
                                    <span
                                        >La imagen debe tener la mejor calidad
                                        posible para que se vea bien al momento
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="flex justify-center">
                            ...
                            <v-file-input
                                ...
                                variant="solo"
                                @input="
                                    img_logo_ittg.file = $event.target.files[0]
                                "
                            ></v-file-input>
                            <!--                                            </div>-->
                            <div class="flex justify-end mt-2 ml-5 w-11">
                        ...
                        <div class="flex justify-center">
                            <v-file-input
                                ...
                                variant="solo"
                                @input="
                                    img_logo_tecnm.file = $event.target.files[0]
                                "
                            ></v-file-input>
                            <div class="flex justify-end mt-2 ml-5 w-11">
                                <v-btn
